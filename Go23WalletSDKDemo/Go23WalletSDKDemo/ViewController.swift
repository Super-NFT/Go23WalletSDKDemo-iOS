...
//                        hud.mode = .text
//                        hud.label.font = UIFont(name: NotoSans, size: 16)
//                        hud.label.text = "Pincode cancel, please try again!"
//                        hud.hide(animated: true, afterDelay: 1)
                        let totast = Go23Toast.init(frame: .zero)
...
//        self.hud = MBProgressHUD.showAdded(to: currentViewController()?.view ?? UIView(), animated: true)
        Go23Loading.loading()
...
extension ViewController: Go23ConnectDelegate {
...
extension ViewController: Go23ReshardDelegate {
...
extension ViewController: Go23SetPincodeDelegate {
